                            ...
                            <div class="member mt-3">
                                ...
                                <form class="form-inline" method="post" action="{{ route('checkout-create', $item->id) }}">
                                    ...
                                    <div class="input-group mb-2 mr-sm-2">
                                        <input type="text" name="doe_passport" class="form-contol datepicker" id="doe_passport" placeholder="DOE Passport" required />
                                    </div>
                        ...
                        <div class="card card-details card-right">
                            ...
                            <div class="bank">
                                <div class="bank-item pb-3">
                                    <img src="{{ url('frontend/images/payments.png') }}" alt="" class="bank-image">
